    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('customer', 'Customer'), ('provider', 'Service Provider'), ('admin', 'Administrator')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('GARDENING', 'Gardening & Maintenance'), ('LANDSCAPING', 'Landscaping & Design'), ('CONSULTING', 'Consulting & Advisory'), ('EDUCATION', 'Classes & Workshops'), ('SUPPLIES', 'Tools & Supplies'), ('OTHER', 'Other Services')], max_length=20)),
